...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(w, c, q) {
  w != Array.prototype && w != Object.prototype && (w[c] = q.value);
};
$jscomp.getGlobal = function(w) {
  return "undefined" != typeof window && window === w ? w : "undefined" != typeof global && null != global ? global : w;
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(w, c, q, m) {
  if (c) {
    q = $jscomp.global;
    w = w.split(".");
    ...
    m = q[w];
    c = c(m);
    c != m && null != c && $jscomp.defineProperty(q, w, {configurable:!0, writable:!0, value:c});
  }
};
$jscomp.polyfill("Array.prototype.fill", function(w) {
  return w ? w : function(c, q, m) {
    var g = this.length || 0;
...
(function(w) {
  ...
  m.prototype.computeSize = function(a, b) {
    ...
    a = 0;
    this.widgets && this.widgets.length && (a = this.widgets.length * (e.NODE_WIDGET_HEIGHT + 4) + 8);
    b[1] = this.widgets_up ? Math.max(b[1], a) : null != this.widgets_start_y ? Math.max(b[1], a + this.widgets_start_y) : b[1] + a;
    a = d(this.title);
    var f = 0, c = 0;
    if (this.inputs) {
      for (var k = 0, n = this.inputs.length; k < n; ++k) {
        var p = this.inputs[k];
        p = p.label || p.name || "";
        p = d(p);
        f < p && (f = p);
    ...
    if (this.outputs) {
      for (k = 0, n = this.outputs.length; k < n; ++k) {
        p = this.outputs[k], p = p.label || p.name || "", p = d(p), c < p && (c = p);
      }
    }
    b[0] = Math.max(f + c + 10, a);
          ...
          if (this.dragging_canvas) {
            ...
            if (this.allow_interaction && !this.read_only) {
              ...
              if (this.resizing_node && !this.live_mode) {
                ...
                d = Math.max(this.resizing_node.inputs ? this.resizing_node.inputs.length : 0, this.resizing_node.outputs ? this.resizing_node.outputs.length : 0) * e.NODE_SLOT_HEIGHT + (this.resizing_node.widgets ? this.resizing_node.widgets.length : 0) * (e.NODE_WIDGET_HEIGHT + 4) + 4;
  ...
  l.prototype.computeVisibleNodes = function(a, b) {
    ...
    for (var d = 0, h = a.length; d < h; ++d) {
      var f = a[d];
      (!this.live_mode || f.onDrawBackground || f.onDrawForeground) && v(this.visible_area, f.getBounding(z)) && b.push(f);
    }
    return b;
  };
      ...
      if (c.inputs && c.inputs.length) {
        for (var l = 0; l < c.inputs.length; ++l) {
          ...
          if (g && null != g.link && (g = this.graph.links[g.link])) {
            ...
            if (null != m) {
              var r = g.origin_slot;
              var B = -1 == r ? [m.pos[0] + 10, m.pos[1] + 10] : m.getConnectionPos(!1, r, p);
              ...
              if (v(n, H)) {
                var K = m.outputs[r];
                r = c.inputs[l];
                if (K && r && (m = K.dir || (m.horizontal ? e.DOWN : e.RIGHT), r = r.dir || (c.horizontal ? e.UP : e.LEFT), this.renderLink(a, B, t, g, !1, 0, null, m, r), g && g._last_time && 1000 > b - g._last_time)) {
                  K = 2.0 - 0.002 * (b - g._last_time);
                  var M = a.globalAlpha;
                  a.globalAlpha = M * K;
                  this.renderLink(a, B, t, g, !0, K, "white", m, r);
                  a.globalAlpha = M;
                }
              }
            }
    ...
    for (var p = e.WIDGET_OUTLINE_COLOR, l = e.WIDGET_BGCOLOR, g = e.WIDGET_TEXT_COLOR, t = e.WIDGET_SECONDARY_TEXT_COLOR, m = 0; m < c.length; ++m) {
      ...
      switch(r.type) {
        ...
        case "slider":
          d.fillStyle = l;
          d.fillRect(15, q, f - 30, k);
          var z = r.options.max - r.options.min, v = (r.value - r.options.min) / z;
          d.fillStyle = h == r ? "#89A" : "#678";
          d.fillRect(15, q, v * (f - 30), k);
          n && d.strokeRect(15, q, f - 30, k);
          r.marker && (z = (r.marker - r.options.min) / z, d.fillStyle = "#AA9", d.fillRect(15 + z * (f - 30), q, 2, k));
        ...
        case "combo":
          ...
          (z = r.value, r.options.values && (v = r.options.values, v.constructor === Function && (v = v()), v && v.constructor !== Array && (z = v[r.value])), d.fillText(z, f - 30 - 20, q + 0.7 * k)));
          break;
        case "string":
        case "text":
          d.textAlign = "left";
        ...
        case "textarea":
          ...
          u = 4;
          z = k * u;
          n ? d.roundRect(15, b, f - 30, z, 0.5 * k) : d.rect(15, b, f - 30, z);
          d.fill();
          n && (d.save(), d.beginPath(), d.rect(15, b, f - 30, z), d.clip(), d.stroke(), d.fillStyle = t, null != r.name && d.fillText(r.name, 30, q + 0.7 * k), d.fillStyle = g, d.textAlign = "right", d.fillText(String(r.value).substr(0, 30), f - 30, q + 0.7 * k), d.restore());
          break;
        default:
  ...
  l.prototype.processNodeWidgets = function(a, b, d, c) {
    ...
    for (var h = b[0] - a.pos[0], k = b[1] - a.pos[1], n = a.size[0], p = this, l = this.getCanvasWindow(), g = 0; g < a.widgets.length; ++g) {
      var t = a.widgets[g];
      if (t && !t.disabled && (t == c || 6 < h && h < n - 12 && k > t.last_y && k < t.last_y + e.NODE_WIDGET_HEIGHT)) {
        switch(t.type) {
          case "button":
            if ("mousemove" === d.type) {
              break;
  ...
  l.prototype.showSearchBox = function(a) {
    ...
    function d(a) {
      var b = z;
      z && z.classList.remove("selected");
      z ? (z = a ? z.nextSibling : z.previousSibling) || (z = b) : z = a ? r.childNodes[0] : r.childNodes[r.childNodes.length];
      z && (z.classList.add("selected"), z.scrollIntoView({block:"end", behavior:"smooth"}));
    }
    function c() {
      function a(a, d) {
    ...
    f.search_box = g;
    var r = g.querySelector(".helper"), t = null, q = null, z = null, u = g.querySelector("input");
...
(function(w) {
  ...
  v.prototype.setValue = r.prototype.setValue;
  ...
  h.registerNodeType("basic/array[]", A);
  ...
  h.registerNodeType("basic/object_property", z);
  D.title = "Object keys";
...
(function(w) {
  ...
  v.registerNodeType("events/trigger", q);
  m.title = "Sequencer";
  ...
  v.registerNodeType("events/counter", r);
  l.title = "Delay";
  ...
  v.registerNodeType("events/timer", C);
  y.title = "Data Store";
...
(function(w) {
  ...
  A.registerNodeType("widget/combo", g);
  r.title = "Knob";
  ...
  A.registerNodeType("widget/hslider", C);
  y.title = "Progress";
  ...
  A.registerNodeType("widget/text", v);
  E.title = "Panel";
...
(function(w) {
  ...
  function h() {
    ...
    this.addWidget("toggle", "allow", B.allow_scripts, function(a) {
      B.allow_scripts = a;
    });
    this._func = null;
  }
  ...
  B.registerNodeType("math/converter", c);
  q.title = "Bypass";
  ...
  B.registerNodeType("math/bypass", q);
  m.title = "to Number";
  ...
  B.registerNodeType("math/to_number", m);
  g.title = "Range";
  ...
  B.registerNodeType("math/range", g);
  r.title = "Rand";
  ...
  B.registerNodeType("math/rand", r);
  l.title = "Noise";
  ...
  B.registerNodeType("math/noise", l);
  C.title = "Spikes";
  ...
  B.registerNodeType("math/spikes", C);
  y.title = "Clamp";
  ...
  B.registerNodeType("math/clamp", y);
  v.title = "Lerp";
  ...
  B.registerNodeType("math/lerp", v);
  E.title = "Abs";
  E.desc = "Absolute";
  E.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  B.registerNodeType("math/floor", A);
  e.title = "Frac";
  ...
  B.registerNodeType("math/frac", e);
  z.title = "Smoothstep";
  z.desc = "Smoothstep";
  z.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  B.registerNodeType("math/smoothstep", z);
  D.title = "Scale";
  D.desc = "v * factor";
  D.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  B.registerNodeType("math/scale", D);
  u.title = "Gate";
  ...
  B.registerNodeType("math/gate", u);
  H.title = "Average";
  ...
  B.registerNodeType("math/average", H);
  n.title = "TendTo";
  ...
  B.registerNodeType("math/tendTo", n);
  ...
  p.prototype.onDrawBackground = function(a) {
    this.flags.collapsed || (a.font = "40px Arial", a.fillStyle = "#666", a.textAlign = "center", a.fillText(this.properties.OP, 0.5 * this.size[0], 0.5 * (this.size[1] + B.NODE_TITLE_HEIGHT)), a.textAlign = "left");
  };
  B.registerNodeType("math/operation", p);
  B.registerSearchboxExtra("math/operation", "MAX", {properties:{OP:"max"}, title:"MAX()"});
  B.registerSearchboxExtra("math/operation", "MIN", {properties:{OP:"min"}, title:"MIN()"});
  k.title = "Compare";
  ...
  B.registerNodeType("math/compare", k);
  B.registerSearchboxExtra("math/compare", "==", {outputs:[["A==B", "boolean"]], title:"A==B"});
  B.registerSearchboxExtra("math/compare", "!=", {outputs:[["A!=B", "boolean"]], title:"A!=B"});
  B.registerSearchboxExtra("math/compare", ">", {outputs:[["A>B", "boolean"]], title:"A>B"});
  B.registerSearchboxExtra("math/compare", "<", {outputs:[["A<B", "boolean"]], title:"A<B"});
  B.registerSearchboxExtra("math/compare", ">=", {outputs:[["A>=B", "boolean"]], title:"A>=B"});
  ...
  B.registerNodeType("math/condition", a);
  b.title = "Accumulate";
  ...
  B.registerNodeType("math/accumulate", b);
  ...
  B.registerNodeType("math/trigonometry", d);
  B.registerSearchboxExtra("math/trigonometry", "SIN()", {outputs:[["sin", "number"]], title:"SIN()"});
  B.registerSearchboxExtra("math/trigonometry", "COS()", {outputs:[["cos", "number"]], title:"COS()"});
  B.registerSearchboxExtra("math/trigonometry", "TAN()", {outputs:[["tan", "number"]], title:"TAN()"});
  h.title = "Formula";
  ...
  B.registerNodeType("math/formula", h);
  f.title = "Vec2->XY";
  ...
  B.registerNodeType("math3d/vec2-to-xy", f);
  x.title = "XY->Vec2";
  ...
  B.registerNodeType("math3d/xy-to-vec2", x);
  G.title = "Vec3->XYZ";
  ...
  B.registerNodeType("math3d/vec3-to-xyz", G);
  I.title = "XYZ->Vec3";
  ...
  B.registerNodeType("math3d/xyz-to-vec3", I);
  J.title = "Vec4->XYZW";
  ...
  B.registerNodeType("math3d/vec4-to-xyzw", J);
  L.title = "XYZW->Vec4";
  ...
  B.registerNodeType("math3d/xyzw-to-vec4", L);
})(this);
(function(w) {
  function c() {
...
(function(w) {
  ...
  y.gamma_pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform float u_igamma;\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord);\n\t\t\tcolor.xyz = pow(color.xyz, vec3(u_igamma) );\n\t\t   gl_FragColor = color;\n\t\t}\n\t\t", F.registerNodeType("texture/toviewport", y), v.title = "Copy", v.desc = "Copy Texture", v.widgets_info = {size:{widget:"combo", values:[0, 32, 64, 128, 256, 512, 1024, 
  2048]}, precision:{widget:"combo", values:c.MODE_VALUES}}, v.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  }, e.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tuniform float u_factor;\n\t\tvarying vec2 v_coord;\n\t\t\n\t\tvoid main() {\n\t\t\tgl_FragColor = mix( texture2D( u_texture, v_coord ), texture2D( u_textureB, v_coord ), u_factor );\n\t\t}\n\t\t", F.registerNodeType("texture/temporal_smooth", e), z.title = "Lineal Avg Smooth", z.desc = "Smooth texture linearly over time", z["@samples"] = {type:"number", 
  min:1, max:64, step:1, precision:1}, z.prototype.getPreviewTexture = function() {
    return this._temp_texture2;
  }, z.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      z._shader || (z._shader_copy = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, z.pixel_shader_copy), z._shader_avg = new GL.Shader(GL.Shader.SCREEN_VERTEX_SHADER, z.pixel_shader_avg));
      ...
      if (0 == c || 0 == d % c) {
        ...
        var k = this._temp_texture, f = this._temp_texture2, h = z._shader_copy, e = z._shader_avg, n = this._uniforms;
        n.u_samples = b;
        n.u_isamples = 1.0 / b;
        gl.disable(gl.BLEND);
        gl.disable(gl.DEPTH_TEST);
  ...
  }, z.pixel_shader_copy = "precision highp float;\n\t\tprecision highp float;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tuniform float u_isamples;\n\t\tvarying vec2 v_coord;\n\t\t\n\t\tvoid main() {\n\t\t\tif( v_coord.x <= u_isamples )\n\t\t\t\tgl_FragColor = texture2D( u_texture, vec2(0.5) );\n\t\t\telse\n\t\t\t\tgl_FragColor = texture2D( u_textureB, v_coord - vec2(u_isamples,0.0) );\n\t\t}\n\t\t", z.pixel_shader_avg = "precision highp float;\n\t\tprecision highp float;\n\t\tuniform sampler2D u_texture;\n\t\tuniform int u_samples;\n\t\tuniform float u_isamples;\n\t\tvarying vec2 v_coord;\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 color = vec4(0.0);\n\t\t\tfor(int i = 0; i < 64; ++i)\n\t\t\t{\n\t\t\t\tcolor += texture2D( u_texture, vec2( float(i)*u_isamples,0.0) );\n\t\t\t\tif(i == (u_samples - 1))\n\t\t\t\t\tbreak;\n\t\t\t}\n\t\t\tgl_FragColor = color * u_isamples;\n\t\t}\n\t\t", 
  F.registerNodeType("texture/linear_avg_smooth", z), D.title = "Image to Texture", D.desc = "Uploads an image to the GPU", D.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  F.registerNodeType("texture/lensfx", L), B.title = "Curve", B.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
      b && b.width == a.width && b.height == a.height && b.type == a.type || (b = this._temp_texture = new GL.Texture(a.width, a.height, {type:a.type, format:gl.RGBA, filter:gl.LINEAR}));
  ...
  }, B.prototype.sampleCurve = function(a, b) {
  ...
  }, B.prototype.updateCurve = function() {
  ...
  }, B.prototype.onSerialize = function(a) {
    var b = {}, d;
    ...
    if (!this.flags.collapsed) {
      ...
      this.properties.split_channels ? ("RGB" == d && (this.widgets[1].value = d = "R", this.widgets[1].disabled = !1), this.curve_editor.points = this._points.R, this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, "#111", B.channel_line_colors.R, !0), a.globalCompositeOperation = "lighten", this.curve_editor.points = this._points.G, this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, null, B.channel_line_colors.G, !0), this.curve_editor.points = 
      this._points.B, this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, null, B.channel_line_colors.B, !0), a.globalCompositeOperation = "source-over") : (this.widgets[1].value = d = "RGB", this.widgets[1].disabled = !0);
      this.curve_editor.points = this._points[d];
      this.curve_editor.draw(a, [this.size[0], this.size[1] - this.curve_offset], b, this.properties.split_channels ? null : "#111", B.channel_line_colors[d]);
      a.restore();
    }
  }, B.pixel_shader = "precision highp float;\n\t\tvarying vec2 v_coord;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_curve;\n\t\tuniform float u_range;\n\t\t\n\t\tvoid main() {\n\t\t\tvec4 color = texture2D( u_texture, v_coord ) * u_range;\n\t\t\tcolor.x = texture2D( u_curve, vec2( color.x, 0.5 ) ).x;\n\t\t\tcolor.y = texture2D( u_curve, vec2( color.y, 0.5 ) ).y;\n\t\t\tcolor.z = texture2D( u_curve, vec2( color.z, 0.5 ) ).z;\n\t\t\t//color.w = texture2D( u_curve, vec2( color.w, 0.5 ) ).w;\n\t\t\tgl_FragColor = color;\n\t\t}", 
  F.registerNodeType("texture/curve", B), t.title = "Exposition", t.desc = "Controls texture exposition", t.widgets_info = {exposition:{widget:"slider", min:0, max:3}, precision:{widget:"combo", values:c.MODE_VALUES}}, t.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      var b = this._temp_texture;
      b && b.width == a.width && b.height == a.height && b.type == a.type || (b = this._temp_texture = new GL.Texture(a.width, a.height, {type:a.type, format:gl.RGBA, filter:gl.LINEAR}));
...
(function(w) {
  ...
  if ("undefined" != typeof GL) {
    ...
    r.prototype.onExecute = function() {
      ...
      if (this.properties.precision === LGraphTexture.PASS_THROUGH) {
        ...
        if (c) {
          ...
          gl.disable(gl.BLEND);
          gl.disable(gl.DEPTH_TEST);
          var w = Mesh.getScreenQuad(), A = r._shader;
          this._tex.drawTo(function() {
            c.bind(0);
            A.uniforms({u_texture:0, u_aberration:g, u_distortion:m, u_blur:q}).draw(w);
          });
          this.setOutputData(0, this._tex);
        }
      }
    ...
    g.prototype.onExecute = function() {
      ...
      if (c && r && this.properties.shape) {
        ...
        if (q) {
          ...
          var z = g._second_shader;
          z || (z = g._second_shader = new GL.Shader(g._second_vertex_shader, g._second_pixel_shader));
          ...
          this._temp_texture.drawTo(function() {
            ...
            c.bind(0);
            q.bind(3);
            z.uniforms({u_texture:0, u_mask:2, u_shape:3, u_alpha:n, u_threshold:w, u_pointSize:H, u_itexsize:[1.0 / c.width, 1.0 / c.height]}).draw(D, gl.POINTS);
          });
          this.setOutputData(0, this._temp_texture);
        }
      } else {
    ...
    g.prototype.createPointsMesh = function(c, g, m) {
      for (var l = Math.round(c / m), r = Math.round(g / m), q = new Float32Array(l * r * 2), e = -1, w = 2 / c * m, y = 2 / g * m, u = 0; u < r; ++u) {
      ...
      if (this.isOutputConnected(0)) {
        ...
        if (this.properties.precision === LGraphTexture.PASS_THROUGH) {
          ...
          if (c) {
            ...
            if (!E) {
              var A = m["pixel_shader_" + q];
              if (!A) {
                return;
              }
              E = m.shaders[q] = new GL.Shader(Shader.SCREEN_VERTEX_SHADER, A);
            }
            gl.disable(gl.BLEND);
            gl.disable(gl.DEPTH_TEST);
            var e = Mesh.getScreenQuad();
            var z = w.LS && LS.Renderer._current_camera ? [LS.Renderer._current_camera.near, LS.Renderer._current_camera.far] : [1, 100];
            var D = null;
            "noise" == q && (D = LGraphTexture.getNoiseTexture());
            this._tex.drawTo(function() {
              c.bind(0);
              "noise" == q && D.bind(1);
              E.uniforms({u_texture:0, u_noise:1, u_size:[c.width, c.height], u_rand:[Math.random(), Math.random()], u_value1:g, u_value2:r, u_camera_planes:z}).draw(e);
            });
            this.setOutputData(0, this._tex);
          }
        }
    ...
    q.prototype.onExecute = function() {
      ...
      if (this.properties.precision === LGraphTexture.PASS_THROUGH) {
        ...
        if (c) {
          ...
          gl.disable(gl.BLEND);
          gl.disable(gl.DEPTH_TEST);
          var m = Mesh.getScreenQuad(), r = q._shader, w = this.properties.invert;
          this._tex.drawTo(function() {
            c.bind(0);
            r.uniforms({u_texture:0, u_intensity:g, u_isize:[1 / c.width, 1 / c.height], u_invert:w ? 1 : 0}).draw(m);
          });
          this.setOutputData(0, this._tex);
        }
      }
...
(function(w) {
  ...
  u.registerNodeType("midi/play", z);
  D.title = "MIDI Keys";
...
(function(w) {
  ...
  n.registerNodeType("audio/visualization", z);
  D.prototype.onExecute = function() {
  ...
  c.prototype.onExecute = function() {
    ...
    if (this._ws && this._ws.readyState == WebSocket.OPEN) {
      for (var c = this.properties.room, m = this.properties.only_send_changes, l = 1; l < this.inputs.length; ++l) {
        ...
        if (null != q) {
          try {
            var w = JSON.stringify({type:0, room:c, channel:l, data:q});
          } catch (v) {
            continue;
          }
