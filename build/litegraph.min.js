...
(function(v) {
  ...
  function E(a, b) {
    ...
    this.root = e;
    b.title && (g = document.createElement("div"), g.className = "litemenu-title", g.innerHTML = b.title, e.appendChild(g));
    g = 0;
    for (var c in a) {
    ...
    c = b.left || 0;
    a = b.top || 0;
    b.event && (c = b.event.clientX - 10, a = b.event.clientY - 10, b.title && (a -= 20), b.parentMenu && (c = b.parentMenu.root.getBoundingClientRect(), c = c.left + c.width), g = document.body.getBoundingClientRect(), k = e.getBoundingClientRect(), 0 == g.height && console.error("document.body height is 0. That is dangerous, set html,body { height: 100%; }"), g.width && c > g.width - k.width - 10 && (c = g.width - k.width - 10), g.height && a > g.height - k.height - 10 && (a = g.height - k.height - 
    10));
    e.style.left = c + "px";
    e.style.top = a + "px";
  ...
  LINEAR_LINK:1, SPLINE_LINK:2, NORMAL_TITLE:0, NO_TITLE:1, TRANSPARENT_TITLE:2, AUTOHIDE_TITLE:3, proxy:null, node_images_path:"", debug:!1, catch_exceptions:!0, throw_errors:!0, allow_scripts:!1, registered_node_types:{}, node_types_by_file_extension:{}, Nodes:{}, searchbox_extras:{}, registerNodeType:function(a, b) {
    ...
    if (f = this.registered_node_types[a]) {
      ...
      if (Object.hasOwnProperty(b.prototype, "shape") || Object.defineProperty(b.prototype, "shape", {set:function(a) {
        ...
        for (g in b.supported_extensions) {
          var x = b.supported_extensions[g];
    ...
    for (f in this.registered_node_types) {
      ...
      b && g.filter && g.filter != b || ("" == a ? null == g.category && d.push(g) : g.category == a && d.push(g));
    }
    return d;
    ...
    if (g) {
      ...
      if (b) {
        ...
        try {
          for (x = 0; x < a; x++) {
            for (c = 0; c < d; ++c) {
              if (k = g[c], k.mode == e.ALWAYS && k.onExecute) {
                k.onExecute();
              }
            }
            this.fixedtime += this.fixedtime_lapse;
  ...
  c.prototype.computeExecutionOrder = function(a, b) {
    for (var d = [], f = [], g = {}, x = {}, c = {}, k = 0, n = this._nodes.length; k < n; ++k) {
      var p = this._nodes[k];
      if (!a || p.onExecute) {
        g[p.id] = p;
        var l = 0;
        ...
        0 == l ? (f.push(p), b && (p._level = 1)) : (b && (p._level = 0), c[p.id] = l);
      }
    }
    for (; 0 != f.length;) {
      if (p = f.shift(), d.push(p), delete g[p.id], p.outputs) {
        for (k = 0; k < p.outputs.length; k++) {
          if (a = p.outputs[k], null != a && null != a.links && 0 != a.links.length) {
            for (t = 0; t < a.links.length; t++) {
              (n = this.links[a.links[t]]) && !x[n.id] && (l = this.getNodeById(n.target_id), null == l ? x[n.id] = !0 : (b && (!l._level || l._level <= p._level) && (l._level = p._level + 1), x[n.id] = !0, --c[l.id], 0 == c[l.id] && f.push(l)));
            }
          }
        }
      }
    ...
    for (f = 0; f < d.length; ++f) {
      if (x = d[f]) {
        for (var c = 100, k = a + e.NODE_TITLE_HEIGHT, n = 0; n < x.length; ++n) {
          g = x[n], g.pos[0] = b, g.pos[1] = k, g.size[0] > c && (c = g.size[0]), k += g.size[1] + a + e.NODE_TITLE_HEIGHT;
        }
        b += c + a;
      }
    }
  ...
  c.prototype.add = function(a, b) {
    if (a) {
      if (console.log("-> Adding node", a), a.constructor === h) {
  ...
  c.prototype.configure = function(a, b) {
    if (a) {
      ...
      if (b) {
        ...
        f = 0;
        for (g = b.length; f < g; ++f) {
          c = b[f], (k = this.getNodeById(c.id)) && k.configure(c);
        }
      }
        ...
        for (d = 0; d < this.outputs.length; ++d) {
          ...
          if (g.links) {
            for (b = 0; b < g.links.length; ++b) {
              f = this.graph ? this.graph.links[g.links[b]] : null, this.onConnectionsChange(e.OUTPUT, d, !0, f, g);
            }
          }
        }
      }
    ...
    if (this.outputs && (a = this.outputs[a]) && (a = a.links) && a.length) {
      ...
      for (var f = 0; f < a.length; ++f) {
        ...
        if (null == d || d == g) {
          ...
          if (c && (c._last_time = e.getTime(), g = this.graph.getNodeById(c.target_id))) {
            if (c = g.inputs[c.target_slot], g.onAction) {
              g.onAction(c.name, b);
            } else {
              if (g.mode === e.ON_TRIGGER && g.onExecute) {
                g.onExecute(b);
              }
            }
          }
  ...
  m.prototype.addWidget = function(a, b, d, f, g) {
  ...
  m.prototype.getSlotInPosition = function(a, b) {
    ...
    if (this.outputs) {
      for (f = 0, g = this.outputs.length; f < g; ++f) {
        if (e = this.outputs[f], this.getConnectionPos(!1, f, d), y(a, b, d[0] - 10, d[1] - 5, 20, 10)) {
  ...
  m.prototype.connect = function(a, b, d) {
    ...
    var g = b.inputs[d], c = null;
    if (e.isValidConnection(f.type, g.type)) {
      c = new q(++this.graph.last_link_id, g.type, this.id, a, b.id, d);
      ...
      if (b.onConnectionsChange) {
        b.onConnectionsChange(e.INPUT, d, !0, c, g);
      }
  ...
  m.prototype.disconnectInput = function(a) {
    ...
    if (f) {
      ...
      if (g.onConnectionsChange) {
        g.onConnectionsChange(e.OUTPUT, k, !1, f, c);
      }
      this.graph && this.graph.onNodeConnectionChange && (this.graph.onNodeConnectionChange(e.OUTPUT, g, k), this.graph.onNodeConnectionChange(e.INPUT, this, a));
    }
    this.setDirtyCanvas(!1, !0);
    this.graph.connectionChange(this);
    return !0;
  ...
  h.prototype.recomputeInsideNodes = function() {
    ...
    for (var a = this.graph._nodes, b = new Float32Array(4), d = 0; d < a.length; ++d) {
      var f = a[d];
      f.getBounding(b);
      w(this._bounding, b) && this._nodes.push(f);
    }
  };
  ...
  r.prototype.onMouse = function(a) {
    if (this.enabled) {
      ...
      if ("mousedown" == a.type) {
        ...
        if ("mousemove" == a.type) {
          g || (b = f - this.last_mouse[0], g = d - this.last_mouse[1], this.dragging && this.mouseDrag(b, g));
        } else {
          if ("mouseup" == a.type) {
  ...
  l.prototype.processMouseDown = function(a) {
    if (this.graph) {
      ...
      var d = this.graph.getNodeOnPos(a.canvasX, a.canvasY, this.visible_nodes, 5), f = !1, g = 300 > e.getTime() - this.last_mouseclick;
        ...
        if (1 == a.which) {
          ...
          if (d && this.allow_interaction && !f && !this.read_only) {
            ...
            if (!this.connecting_node && !d.flags.collapsed && !this.live_mode) {
              if (!f && !1 !== d.resizable && y(a.canvasX, a.canvasY, d.pos[0] + d.size[0] - 5, d.pos[1] + d.size[1] - 5, 10, 10)) {
          ...
          if (this.dragging_canvas) {
            ...
            if (this.allow_interaction && !this.read_only) {
              ...
              if (f) {
                ...
                if (this.connecting_node && (g = this._highlight_input || [0, 0], !this.isOverNodeBox(f, a.canvasX, a.canvasY))) {
                  var c = this.isOverNodeInput(f, a.canvasX, a.canvasY, g);
                  -1 != c && f.inputs[c] ? e.isValidConnection(this.connecting_output.type, f.inputs[c].type) && (this._highlight_input = g) : this._highlight_input = null;
                }
                this.canvas && (y(a.canvasX, a.canvasY, f.pos[0] + f.size[0] - 5, f.pos[1] + f.size[1] - 5, 5, 5) ? this.canvas.style.cursor = "se-resize" : this.canvas.style.cursor = "crosshair");
              } else {
                g = null;
      ...
      if (1 == a.which) {
        ...
        !0), this.selected_group = null), this.selected_group_resizing = !1, this.dragging_rectangle) {
          if (this.graph) {
            ...
            var f = Math.abs(this.dragging_rectangle[2]), g = Math.abs(this.dragging_rectangle[3]), c = 0 > this.dragging_rectangle[3] ? this.dragging_rectangle[1] - g : this.dragging_rectangle[1];
            ...
            for (c = 0; c < b.length; ++c) {
              f = b[c], f.getBounding(d), w(this.dragging_rectangle, d) && g.push(f);
            }
          ...
          if (this.connecting_node) {
            ...
            if (this.resizing_node) {
              ...
              if (this.node_dragged) {
                (f = this.node_dragged) && 300 > a.click_time && y(a.canvasX, a.canvasY, f.pos[0], f.pos[1] - e.NODE_TITLE_HEIGHT, e.NODE_TITLE_HEIGHT, e.NODE_TITLE_HEIGHT) && f.collapse();
                this.dirty_bgcanvas = this.dirty_canvas = !0;
  ...
  l.prototype.isOverNodeBox = function(a, b, d) {
    ...
    return y(b, d, a.pos[0] + 2, a.pos[1] + 2 - f, f - 4, f - 4) ? !0 : !1;
  };
  ...
  l.prototype.pasteFromClipboard = function() {
    ...
    if (a) {
      ...
      for (var b = [], d = 0; d < a.nodes.length; ++d) {
        var f = a.nodes[d], g = e.createNode(f.type);
        g && (g.configure(f), g.pos[0] += 5, g.pos[1] += 5, this.graph.add(g), b.push(g));
      }
      for (d = 0; d < a.links.length; ++d) {
        f = a.links[d];
        g = b[f[0]];
        var c = b[f[2]];
        g && c ? g.connect(f[1], c, f[3]) : console.warn("Warning, nodes missing on pasting");
      }
      this.selectNodes(b);
    }
  };
  ...
  l.prototype.computeVisibleNodes = function(a, b) {
    ...
    for (var d = 0, f = a.length; d < f; ++d) {
      var g = a[d];
      (!this.live_mode || g.onDrawBackground || g.onDrawForeground) && w(this.visible_area, g.getBounding(C)) && b.push(g);
    }
    return b;
  };
  ...
  l.prototype.drawNode = function(a, b) {
    ...
    if (this.live_mode) {
      ...
      if (!a.flags.collapsed || !a.onDrawCollapsed || 1 != a.onDrawCollapsed(b, this)) {
        ...
        a.has_errors && (f = "red");
        this.drawNodeShape(a, b, D, d, f, a.is_selected, a.mouseOver);
        ...
        if (!a.flags.collapsed) {
          if (a.inputs) {
            for (d = 0; d < a.inputs.length; d++) {
              ...
              b.beginPath();
              h.type === e.EVENT || h.shape === e.BOX_SHAPE ? n ? b.rect(t[0] - 5 + 0.5, t[1] - 8 + 0.5, 10, 14) : b.rect(t[0] - 6 + 0.5, t[1] - 5 + 0.5, 14, 10) : h.shape === e.ARROW_SHAPE ? (b.moveTo(t[0] + 8, t[1] + 0.5), b.lineTo(t[0] - 4, t[1] + 6 + 0.5), b.lineTo(t[0] - 4, t[1] - 6 + 0.5), b.closePath()) : g ? b.rect(t[0] - 4, t[1] - 4, 8, 8) : b.arc(t[0], t[1], 4, 0, 2 * Math.PI);
              b.fill();
              if (f) {
          ...
          if (a.outputs) {
            for (d = 0; d < a.outputs.length; d++) {
              ...
              h.shape === e.ARROW_SHAPE ? (b.moveTo(t[0] + 8, t[1] + 0.5), b.lineTo(t[0] - 4, t[1] + 6 + 0.5), b.lineTo(t[0] - 4, t[1] - 6 + 0.5), b.closePath()) : g ? b.rect(t[0] - 4, t[1] - 4, 8, 8) : b.arc(t[0], t[1], 4, 0, 2 * Math.PI), b.fill(), g || b.stroke(), f && (m = null != h.label ? h.label : h.name)) {
          ...
          if (this.render_collapsed_slots) {
            ...
            if (a.outputs) {
              for (d = 0; d < a.outputs.length; d++) {
                h = a.outputs[d], h.links && h.links.length && (g = h);
              }
            }
            ...
            g && (c = a._collapsed_width, d = -0.5 * e.NODE_TITLE_HEIGHT, n && (c = 0.5 * a._collapsed_width, d = 0), b.fillStyle = "#686", b.strokeStyle = "black", b.beginPath(), h.type === e.EVENT || h.shape === e.BOX_SHAPE ? b.rect(c - 7 + 0.5, d - 4, 14, 8) : h.shape === e.ARROW_SHAPE ? (b.moveTo(c + 6, d), b.lineTo(c - 6, d - 4), b.lineTo(c - 6, d + 4), b.closePath()) : b.arc(c, d, 4, 0, 2 * Math.PI), b.fill());
          }
        }
  ...
  l.prototype.drawNodeShape = function(a, b, d, f, g, c, k) {
    b.strokeStyle = f;
    b.fillStyle = g;
    ...
    if (h || x == e.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        ...
        if (x != e.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          ...
          b.beginPath();
          p == e.BOX_SHAPE || n ? b.rect(0, -g, d[0] + 1, g) : (p == e.ROUND_SHAPE || p == e.CARD_SHAPE) && b.roundRect(0, -g, d[0] + 1, g, this.round_radius, a.flags.collapsed ? this.round_radius : 0);
          b.fill();
          b.shadowColor = "transparent";
        }
      }
      if (a.onDrawTitleBox) {
        ...
        p == e.ROUND_SHAPE || p == e.CIRCLE_SHAPE || p == e.CARD_SHAPE ? (n && (b.fillStyle = "black", b.beginPath(), b.arc(0.5 * g, -0.5 * g, 6, 0, 2 * Math.PI), b.fill()), b.fillStyle = a.boxcolor || e.NODE_DEFAULT_BOXCOLOR, n ? b.fillRect(0.5 * g - 5, -0.5 * g - 5, 10, 10) : (b.beginPath(), b.arc(0.5 * g, -0.5 * g, 5, 0, 2 * Math.PI), b.fill())) : (n && (b.fillStyle = "black", b.fillRect(0.5 * (g - 10) - 1, -0.5 * (g + 10) - 1, 12, 12)), b.fillStyle = a.boxcolor || e.NODE_DEFAULT_BOXCOLOR, b.fillRect(0.5 * 
        (g - 10), -0.5 * (g + 10), 10, 10));
      }
      b.globalAlpha = k;
      ...
      !n && (b.font = this.title_text_font, n = String(a.getTitle())) && (b.fillStyle = c ? "white" : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "left", b.measureText(n), b.fillText(n.substr(0, 20), g, e.NODE_TITLE_TEXT_Y - g), b.textAlign = "left") : (b.textAlign = "left", b.fillText(n, g, e.NODE_TITLE_TEXT_Y - g)));
      if (a.onDrawTitle) {
        a.onDrawTitle(b);
      }
    }
    if (c) {
      ...
      x == e.TRANSPARENT_TITLE && (u[1] -= g, u[3] += g);
      b.lineWidth = 1;
      b.globalAlpha = 0.8;
      b.beginPath();
          ...
          if (h && null != h.link && (h = this.graph.links[h.link])) {
            ...
            if (null != m) {
              ...
              if (w(n, H)) {
                var K = m.outputs[r];
                r = c.inputs[l];
                if (K && r && (m = K.dir || (m.horizontal ? e.DOWN : e.RIGHT), r = r.dir || (c.horizontal ? e.UP : e.LEFT), this.renderLink(a, A, t, h, !1, 0, null, m, r), h && h._last_time && 1000 > b - h._last_time)) {
                  K = 2.0 - 0.002 * (b - h._last_time);
                  var M = a.globalAlpha;
                  a.globalAlpha = M * K;
                  this.renderLink(a, A, t, h, !0, K, "white", m, r);
                  a.globalAlpha = M;
                }
              }
            }
  ...
  l.prototype.renderLink = function(a, b, d, f, g, c, k, n, p, h) {
    ...
    a.stroke();
    g = this.computeConnectionPoint(b, d, 0.5, n, p);
    f && f._pos && (f._pos[0] = g[0], f._pos[1] = g[1]);
    0.6 <= this.ds.scale && this.highquality_render && p != e.CENTER && (this.render_connection_arrows && (t = this.computeConnectionPoint(b, d, 0.25, n, p), x = this.computeConnectionPoint(b, d, 0.26, n, p), f = this.computeConnectionPoint(b, d, 0.75, n, p), h = this.computeConnectionPoint(b, d, 0.76, n, p), this.render_curved_connections ? (x = -Math.atan2(x[0] - t[0], x[1] - t[1]), h = -Math.atan2(h[0] - f[0], h[1] - f[1])) : h = x = d[1] > b[1] ? 0 : Math.PI, a.save(), a.translate(t[0], t[1]), 
    a.rotate(x), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore(), a.save(), a.translate(f[0], f[1]), a.rotate(h), a.beginPath(), a.moveTo(-5, -3), a.lineTo(0, 7), a.lineTo(5, -3), a.fill(), a.restore()), a.beginPath(), a.arc(g[0], g[1], 5, 0, 2 * Math.PI), a.fill());
    if (c) {
      for (a.fillStyle = k, t = 0; 5 > t; ++t) {
        c = (0.001 * e.getTime() + 0.2 * t) % 1, g = this.computeConnectionPoint(b, d, c, n, p), a.beginPath(), a.arc(g[0], g[1], 5, 0, 2 * Math.PI), a.fill();
      }
    }
  };
  l.prototype.computeConnectionPoint = function(a, b, d, f, g) {
    f = f || e.RIGHT;
    g = g || e.LEFT;
    ...
    c = 3 * (1 - d) * d * d;
    d *= d * d;
    return [f * a[0] + g * k[0] + c * n[0] + d * b[0], f * a[1] + g * k[1] + c * n[1] + d * b[1]];
  };
    ...
    for (var p = e.WIDGET_OUTLINE_COLOR, l = e.WIDGET_BGCOLOR, h = e.WIDGET_TEXT_COLOR, t = e.WIDGET_SECONDARY_TEXT_COLOR, m = 0; m < c.length; ++m) {
      ...
      switch(r.type) {
        case "button":
          ...
          d.fillRect(15, q, g - 30, k);
          n && d.strokeRect(15, q, g - 30, k);
          n && (d.textAlign = "center", d.fillStyle = h, d.fillText(r.name, 0.5 * g, q + 0.7 * k));
          break;
        case "toggle":
          d.textAlign = "left";
          d.strokeStyle = p;
          d.fillStyle = l;
          d.beginPath();
          n ? d.roundRect(15, b, g - 30, k, 0.5 * k) : d.rect(15, b, g - 30, k);
          d.fill();
          n && d.stroke();
          d.fillStyle = r.value ? "#89A" : "#333";
          d.beginPath();
          d.arc(g - 30, q + 0.5 * k, 0.36 * k, 0, 2 * Math.PI);
          d.fill();
          n && (d.fillStyle = t, null != r.name && d.fillText(r.name, 30, q + 0.7 * k), d.fillStyle = r.value ? h : t, d.textAlign = "right", d.fillText(r.value ? r.options.on || "true" : r.options.off || "false", g - 40, q + 0.7 * k));
          break;
        case "slider":
          d.fillStyle = l;
          d.fillRect(15, q, g - 30, k);
          var u = r.options.max - r.options.min, C = (r.value - r.options.min) / u;
          d.fillStyle = f == r ? "#89A" : "#678";
          d.fillRect(15, q, C * (g - 30), k);
          n && d.strokeRect(15, q, g - 30, k);
          r.marker && (u = (r.marker - r.options.min) / u, d.fillStyle = "#AA9", d.fillRect(15 + u * (g - 30), q, 2, k));
          n && (d.textAlign = "center", d.fillStyle = h, d.fillText(r.name + "  " + Number(r.value).toFixed(3), 0.5 * g, q + 0.7 * k));
          break;
        case "number":
        case "combo":
          d.textAlign = "left";
          ...
          n ? d.roundRect(15, b, g - 30, k, 0.5 * k) : d.rect(15, b, g - 30, k);
          d.fill();
          n && (d.stroke(), d.fillStyle = h, d.beginPath(), d.moveTo(31, b + 5), d.lineTo(21, b + 0.5 * k), d.lineTo(31, b + k - 5), d.fill(), d.beginPath(), d.moveTo(g - 15 - 16, b + 5), d.lineTo(g - 15 - 6, b + 0.5 * k), d.lineTo(g - 15 - 16, b + k - 5), d.fill(), d.fillStyle = t, d.fillText(r.name, 35, q + 0.7 * k), d.fillStyle = h, d.textAlign = "right", "number" == r.type ? d.fillText(Number(r.value).toFixed(void 0 !== r.options.precision ? r.options.precision : 3), g - 30 - 20, q + 0.7 * k) : 
          (u = r.value, r.options.values && (C = r.options.values, C.constructor === Function && (C = C()), C && C.constructor !== Array && (u = C[r.value])), d.fillText(u, g - 30 - 20, q + 0.7 * k)));
          break;
        case "string":
        case "text":
          d.textAlign = "left";
          ...
          n ? d.roundRect(15, b, g - 30, k, 0.5 * k) : d.rect(15, b, g - 30, k);
          d.fill();
          n && (d.save(), d.beginPath(), d.rect(15, b, g - 30, k), d.clip(), d.stroke(), d.fillStyle = t, null != r.name && d.fillText(r.name, 30, q + 0.7 * k), d.fillStyle = h, d.textAlign = "right", d.fillText(String(r.value).substr(0, 30), g - 30, q + 0.7 * k), d.restore());
          break;
        case "textarea":
          d.textAlign = "left";
          d.strokeStyle = p;
          ...
          d.beginPath();
          u = k;
          n ? d.roundRect(15, b, g - 30, u, 0.5 * e.NODE_WIDGET_HEIGHT) : d.rect(15, b, g - 30, u);
          d.fill();
          n && (d.save(), d.beginPath(), d.rect(15, b, g - 30, u), d.clip(), d.stroke(), d.fillStyle = t, null != r.name && d.fillText(r.name + ":", 30, q + 0.7 * e.NODE_WIDGET_HEIGHT), d.fillStyle = h, d.textAlign = "left", d.fillText(String(r.value).substr(0, 30), 30, q + 1.4 * e.NODE_WIDGET_HEIGHT), d.restore());
          break;
        default:
  ...
  l.prototype.processNodeWidgets = function(a, b, d, c) {
    function g(g, f) {
      g.value = f;
      g.options && g.options.property && void 0 !== a.properties[g.options.property] && a.setProperty(g.options.property, f);
      g.callback && g.callback(g.value, p, a, b, d);
    }
    if (!a.widgets || !a.widgets.length) {
      return null;
    }
    for (var f = b[0] - a.pos[0], k = b[1] - a.pos[1], n = a.size[0], p = this, l = this.getCanvasWindow(), h = 0; h < a.widgets.length; ++h) {
      var t = a.widgets[h];
      if (t && !t.disabled && (t == c || 6 < f && f < n - 12 && k > t.last_y && k < t.last_y + e.NODE_WIDGET_HEIGHT * t.options.heightScale)) {
        switch(t.type) {
          case "button":
            if ("mousemove" === d.type) {
              break;
          ...
          case "combo":
            ...
            if ("mousemove" == d.type && "number" == t.type) {
              ...
              if ("mousedown" == d.type) {
                ...
                f = 40 > f ? -1 : f > n - 40 ? 1 : 0;
                if ("number" == t.type) {
                  t.value += 0.1 * f * (t.options.step || 1), null != t.options.min && t.value < t.options.min && (t.value = t.options.min), null != t.options.max && t.value > t.options.max && (t.value = t.options.max);
                } else {
                  if (f) {
                    l = -1, l = m.constructor === Object ? r.indexOf(String(t.value)) + f : r.indexOf(t.value) + f, l >= r.length && (l = r.length - 1), 0 > l && (l = 0), t.value = m.constructor === Array ? m[l] : l;
                  } else {
                ...
                "mouseup" == d.type && "number" == t.type && (f = 40 > f ? -1 : f > n - 40 ? 1 : 0, 200 > d.click_time && 0 == f && this.prompt("Value", t.value, function(a) {
                  this.value = Number(a);
                  g(this, this.value);
                }.bind(t), d));
              }
  ...
  l.prototype.drawGroups = function(a, b) {
    if (this.graph) {
      ...
      for (var d = 0; d < a.length; ++d) {
        var f = a[d];
        if (w(this.visible_area, f._bounding)) {
  ...
  l.onMenuAdd = function(a, b, d, c, g) {
    function f(a, b) {
      b = c.getFirstEvent();
    ...
    var h = new e.ContextMenu(b, {event:d, callback:function(a, b, d) {
      ...
      new e.ContextMenu(b, {event:d, callback:f, parentMenu:h}, n);
      return !1;
    }, parentMenu:c}, n);
    return !1;
  };
  ...
  l.showMenuNodeOptionalInputs = function(a, b, d, c, g) {
    if (g) {
      var f = this;
      ...
      if (k.length) {
        return new e.ContextMenu(k, {event:d, callback:function(a, b, d) {
          g && (a.callback && a.callback.call(f, g, a, b, d), a.value && (g.addInput(a.value[0], a.value[1], a.value[2]), g.setDirtyCanvas(!0, !0)));
        }, parentMenu:c, node:g}, a), !1;
      }
    }
  };
  l.showMenuNodeOptionalOutputs = function(a, b, d, c, g) {
    function f(a, b, d) {
      if (g && (a.callback && a.callback.call(k, g, a, b, d), a.value)) {
        if (d = a.value[1], !d || d.constructor !== Object && d.constructor !== Array) {
          ...
          new e.ContextMenu(a, {event:b, callback:f, parentMenu:c, node:g});
          return !1;
        }
      }
    }
    if (g) {
      ...
      if (n.length) {
        return new e.ContextMenu(n, {event:d, callback:f, parentMenu:c, node:g}, a), !1;
      }
    }
  };
  l.onShowMenuNodeProperties = function(a, b, d, c, g) {
    if (g && g.properties) {
      var f = l.active_canvas;
      b = f.getCanvasWindow();
      var k = [], n;
      for (n in g.properties) {
        a = void 0 !== g.properties[n] ? g.properties[n] : " ", "object" == typeof a && (a = JSON.stringify(a)), a = l.decodeHTML(a), k.push({content:"<span class='property_name'>" + n + "</span><span class='property_value'>" + a + "</span>", value:n});
      }
      if (k.length) {
        return new e.ContextMenu(k, {event:d, callback:function(a, b, d, c) {
          g && (b = this.getBoundingClientRect(), f.showEditPropertyValue(g, a.value, {position:[b.left, b.top]}));
        }, parentMenu:c, allow_html:!0, node:g}, b), !1;
      }
    }
  };
  ...
  l.onResizeNode = function(a, b, d, c, g) {
      ...
      switch(b) {
        case "Add Node":
          l.onMenuAdd(null, null, e, c, function(b) {
            ...
            var g = d.graph.getNodeById(a.origin_id), c = d.graph.getNodeById(a.target_id);
            b.inputs && b.inputs.length && b.outputs && b.outputs.length && g.outputs[a.origin_slot].type == b.inputs[0].type && b.outputs[0].type == c.inputs[0].type && (g.connect(a.origin_slot, b, 0), b.connect(0, c, a.target_slot), b.pos[0] -= 0.5 * b.size[0]);
          });
          break;
        case "Delete":
  ...
  l.onShowPropertyEditor = function(a, b, d, c, g) {
    function f() {
      var b = n.value;
  ...
  l.prototype.prompt = function(a, b, d, c) {
    var g = this;
    a = a || "";
    var e = !1, f = document.createElement("div");
    ...
    var n = -20, p = -20;
    b && (n -= b.left, p -= b.top);
    c ? (f.style.left = c.clientX + n + "px", f.style.top = c.clientY + p + "px") : (f.style.left = 0.5 * a.width + n + "px", f.style.top = 0.5 * a.height + p + "px");
      ...
      if (d) {
        if (g.onSearchBox) {
          ...
          for (f in e.searchbox_extras) {
            var h = e.searchbox_extras[f];
            if (-1 !== h.desc.toLowerCase().indexOf(d)) {
              var m = e.registered_node_types[h.type];
          ...
          if (Array.prototype.filter) {
            ...
            for (f in h = [], e.registered_node_types) {
              c(f) && h.push(f);
            }
          }
          for (f = 0; f < h.length && !(a(h[f]), -1 !== l.search_limit && n++ > l.search_limit); f++) {
          }
        }
      }
    }
    var g = this, k = l.active_canvas, n = k.canvas, p = n.ownerDocument || document, h = document.createElement("div");
  ...
  l.prototype.createDialog = function(a, b) {
    ...
    var c = -20, g = -20;
    a && (c -= a.left, g -= a.top);
    b.position ? (c += b.position[0], g += b.position[1]) : b.event ? (c += b.event.clientX, g += b.event.clientY) : (c += 0.5 * this.canvas.width, g += 0.5 * this.canvas.height);
    d.style.left = c + "px";
    d.style.top = g + "px";
  ...
  l.onMenuNodeCollapse = function(a, b, d, c, g) {
    g.collapse();
  };
  l.onMenuNodePin = function(a, b, d, c, g) {
    g.pin();
  };
  l.onMenuNodeMode = function(a, b, d, c, g) {
  ...
  l.onMenuNodeColors = function(a, b, d, c, g) {
    if (!g) {
      throw "no node for color";
    }
    b = [];
    b.push({value:null, content:"<span style='display: block; padding-left: 4px;'>No color</span>"});
    for (var f in l.node_colors) {
      a = l.node_colors[f], a = {value:f, content:"<span style='display: block; color: #999; padding-left: 4px; border-left: 8px solid " + a.color + "; background-color:" + a.bgcolor + "'>" + f + "</span>"}, b.push(a);
    }
    new e.ContextMenu(b, {event:d, callback:function(a) {
      g && ((a = a.value ? l.node_colors[a.value] : null) ? g.constructor === e.LGraphGroup ? g.color = a.groupcolor : (g.color = a.color, g.bgcolor = a.bgcolor) : (delete g.color, delete g.bgcolor), g.setDirtyCanvas(!0, !0));
    }, parentMenu:c, node:g});
    return !1;
  };
  l.onMenuNodeShapes = function(a, b, d, c, g) {
    if (!g) {
  ...
  l.onMenuNodeRemove = function(a, b, d, c, g) {
    if (!g) {
      throw "no node passed";
    }
    !1 !== g.removable && (g.graph.remove(g), g.setDirtyCanvas(!0, !0));
  };
  l.onMenuNodeClone = function(a, b, d, c, g) {
  ...
  l.prototype.processContextMenu = function(a, b) {
    var d = this, c = l.active_canvas.getCanvasWindow(), g = null, k = {event:b, callback:function(b, g, c) {
      if (b) {
        if ("Remove Slot" == b.content) {
          ...
          if ("Disconnect Links" == b.content) {
            ...
            if ("Rename Slot" == b.content) {
              b = b.slot;
              var f = b.input ? a.getInputInfo(b.slot) : a.getOutputInfo(b.slot), e = d.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>", g), k = e.querySelector("input");
              k && f && (k.value = f.label || "");
              e.querySelector("button").addEventListener("click", function(a) {
                k.value && (f && (f.label = k.value), d.setDirty(!0));
                e.close();
              });
            }
          }
    ...
    n ? (g = [], a.getSlotMenuOptions ? g = a.getSlotMenuOptions(n) : (n && n.output && n.output.links && n.output.links.length && g.push({content:"Disconnect Links", slot:n}), b = n.input || n.output, g.push(b.locked ? "Cannot remove" : {content:"Remove Slot", slot:n}), g.push(b.nameLocked ? "Cannot rename" : {content:"Rename Slot", slot:n})), k.title = (n.input ? n.input.type : n.output.type) || "*", n.input && n.input.type == e.ACTION && (k.title = "Action"), n.output && n.output.type == e.EVENT && 
    (k.title = "Event")) : a ? g = this.getNodeMenuOptions(a) : (g = this.getCanvasMenuOptions(), (n = this.graph.getGroupOnPos(b.canvasX, b.canvasY)) && g.push(null, {content:"Edit Group", has_submenu:!0, submenu:{title:"Group", extra:n, options:this.getGroupMenuOptions(n)}}));
    g && new e.ContextMenu(g, k, c);
  };
  "undefined" != typeof window && window.CanvasRenderingContext2D && (window.CanvasRenderingContext2D.prototype.roundRect = function(a, b, d, c, g, e) {
    void 0 === g && (g = 5);
    void 0 === e && (e = g);
    this.moveTo(a + g, b);
    this.lineTo(a + d - g, b);
  ...
  e.hex2num = function(a) {
    ...
    a = a.toUpperCase();
    for (var b = Array(3), d = 0, c, g, e = 0; 6 > e; e += 2) {
      c = "0123456789ABCDEF".indexOf(a.charAt(e)), g = "0123456789ABCDEF".indexOf(a.charAt(e + 1)), b[d] = 16 * c + g, d++;
    }
    return b;
  };
  e.num2hex = function(a) {
    for (var b = "#", d, c, g = 0; 3 > g; g++) {
      d = a[g] / 16, c = a[g] % 16, b += "0123456789ABCDEF".charAt(d) + "0123456789ABCDEF".charAt(c);
    }
    return b;
  };
    ...
    if (b) {
      for (var d = 0; d < b.length - 1; ++d) {
        ...
        if (!(g[0] < a)) {
          ...
          a = (a - c[0]) / b;
          return c[1] * (1.0 - a) + g[1] * a;
        }
      }
      return 0;
    }
  };
  z.prototype.draw = function(a, b, d, c, g, e) {
    if (d = this.points) {
      this.size = b;
      ...
      if (!e) {
        for (c = 0; c < d.length; ++c) {
          g = d[c], a.fillStyle = this.selected == c ? "#FFF" : this.nearest == c ? "#DDD" : "#AAA", a.beginPath(), a.arc(g[0] * f, (1.0 - g[1]) * b, 2, 0, 2 * Math.PI), a.fill();
        }
      }
      a.restore();
    }
  ...
  z.prototype.onMouseDown = function(a, b) {
    var d = this.points;
    if (d && !(0 > a[1])) {
      var c = this.size[0] - 2 * this.margin, g = this.size[1] - 2 * this.margin, e = a[0] - this.margin;
      a = a[1] - this.margin;
      this.selected = this.getCloserPoint([e, a], 30 / b.ds.scale);
      -1 == this.selected && (b = [e / c, 1 - a / g], d.push(b), d.sort(function(a, b) {
        return a[0] - b[0];
  ...
  z.prototype.onMouseMove = function(a, b) {
    ...
    if (d) {
      var c = this.selected;
      if (!(0 > c)) {
        var g = (a[0] - this.margin) / (this.size[0] - 2 * this.margin), e = (a[1] - this.margin) / (this.size[1] - 2 * this.margin);
        this._nearest = this.getCloserPoint([a[0] - this.margin, a[1] - this.margin], 30 / b.ds.scale);
        if (b = d[c]) {
          var k = 0 == c || c == d.length - 1;
          !k && (-10 > a[0] || a[0] > this.size[0] + 10 || -10 > a[1] || a[1] > this.size[1] + 10) ? (d.splice(c, 1), this.selected = -1) : (b[0] = k ? 0 == c ? 0 : 1 : Math.clamp(g, 0, 1), b[1] = 1.0 - Math.clamp(e, 0, 1), d.sort(function(a, b) {
            return a[0] - b[0];
          }), this.selected = d.indexOf(b), this.must_update = !0);
        }
      }
  ...
  z.prototype.getCloserPoint = function(a, b) {
    ...
    b = b || 30;
    for (var c = this.size[0] - 2 * this.margin, g = this.size[1] - 2 * this.margin, e = d.length, k = [0, 0], n = 1000000, p = -1, h = 0; h < e; ++h) {
      var l = d[h];
      k[0] = l[0] * c;
      k[1] = (1.0 - l[1]) * g;
      l = vec2.distance(a, k);
...
(function(v) {
  ...
  function n() {
    ...
    this.addInput("download", f.ACTION);
  ...
  function a() {
    this.mode = f.ON_EVENT;
    this.size = [80, 30];
    this.addProperty("msg", "");
    this.addInput("log", f.EVENT);
    this.addInput("msg", 0);
  }
  function b() {
    this.mode = f.ON_EVENT;
    this.addProperty("msg", "");
    this.addInput("", f.EVENT);
    var a = this;
  ...
  f.registerNodeType("basic/time", c);
  q.title = "Subgraph";
  ...
  q.prototype.onDrawTitle = function(a) {
    if (!this.flags.collapsed) {
      a.fillStyle = "#555";
      var b = f.NODE_TITLE_HEIGHT, d = this.size[0] - b;
      a.fillRect(d, -b, b, b);
      a.fillStyle = "#333";
      a.beginPath();
  ...
  q.prototype.onMouseDown = function(a, b, d) {
    if (!this.flags.collapsed && b[0] > this.size[0] - f.NODE_TITLE_HEIGHT && 0 > b[1]) {
      var g = this;
      setTimeout(function() {
        d.openSubgraph(g.subgraph);
      }, 10);
  ...
  q.prototype.serialize = function() {
    var a = f.LGraphNode.prototype.serialize.call(this);
    a.subgraph = this.subgraph.serialize();
    return a;
  };
  q.prototype.clone = function() {
    var a = f.createNode(this.type), b = this.serialize();
    delete b.id;
    delete b.inputs;
    delete b.outputs;
    a.configure(b);
  ...
  f.Subgraph = q;
  f.registerNodeType("graph/subgraph", q);
  m.title = "Input";
  ...
  m.prototype.onAction = function(a, b) {
    this.properties.type == f.EVENT && this.triggerSlot(0, b);
  };
  ...
  f.GraphInput = m;
  f.registerNodeType("graph/input", m);
  h.title = "Output";
  ...
  h.prototype.onAction = function(a, b) {
    this.properties.type == f.ACTION && this.graph.trigger(this.properties.name, b);
  };
  ...
  f.GraphOutput = h;
  f.registerNodeType("graph/output", h);
  ...
  f.registerNodeType("basic/const", r);
  ...
  l.prototype.onGetInputs = function() {
    return [["toggle", f.ACTION]];
  };
  l.prototype.onAction = function(a) {
    this.setValue(!this.properties.value);
  };
  f.registerNodeType("basic/boolean", l);
  ...
  f.registerNodeType("basic/string", B);
  y.title = "Const File";
  ...
  y.prototype.fetchFile = function(a) {
    var b = this;
    a && a.constructor === String ? (this._url = a, this._type = this.properties.type, "http" == a.substr(0, 4) && f.proxy && (a = f.proxy + a.substr(a.indexOf(":") + 3)), fetch(a).then(function(a) {
      if (!a.ok) {
        throw Error("File not found");
      }
  ...
  f.registerNodeType("basic/file", y);
  w.title = "Const Data";
  ...
  f.registerNodeType("basic/data", w);
  E.title = "Const Array";
  ...
  f.registerNodeType("basic/array", E);
  z.title = "Array[i]";
  ...
  f.registerNodeType("basic/array[]", z);
  ...
  f.registerNodeType("basic/table[][]", e);
  ...
  f.registerNodeType("basic/object_property", C);
  D.title = "Object keys";
  ...
  f.registerNodeType("basic/object_keys", D);
  ...
  f.registerNodeType("basic/merge_objects", u);
  H.title = "Variable";
  ...
  f.registerNodeType("basic/variable", H);
  f.wrapFunctionAsNode("basic/length", function(a) {
  ...
  f.registerNodeType("basic/download", n);
  p.title = "Watch";
  ...
  a.prototype.onGetInputs = function() {
    return [["log", f.ACTION], ["warn", f.ACTION], ["error", f.ACTION]];
  };
  f.registerNodeType("basic/console", a);
  b.title = "Alert";
  ...
  f.registerNodeType("basic/alert", b);
  d.prototype.onConfigure = function(a) {
    a.properties.onExecute && f.allow_scripts ? this.compileCode(a.properties.onExecute) : console.warn("Script not compiled, LiteGraph.allow_scripts is false");
  };
  d.title = "Script";
  d.desc = "executes a code (max 100 characters)";
  d.widgets_info = {onExecute:{type:"code"}};
  d.prototype.onPropertyChanged = function(a, b) {
    "onExecute" == a && f.allow_scripts ? this.compileCode(b) : console.warn("Script not compiled, LiteGraph.allow_scripts is false");
  };
  ...
  f.registerNodeType("basic/script", d);
})(this);
(function(v) {
  function c() {
    this.size = [60, 30];
...
(function(v) {
  ...
  A.registerNodeType("math/formula", f);
  g.title = "Vec2->XY";
  ...
  A.registerNodeType("math3d/vec2-to-xy", g);
  x.title = "XY->Vec2";
...
(function(v) {
  ...
  }, l.pixel_shader = "precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv = uv / u_scale - u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t", F.registerNodeType("texture/scaleOffset", l), B.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, B.title = "Warp", B.desc = "Texture warp operation", 
  B.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (this.isOutputConnected(0)) {
      if (this.properties.precision === c.PASS_THROUGH) {
  ...
  }, B.pixel_shader = "precision highp float;\n\t\t\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tvarying vec2 v_coord;\n\t\tuniform float u_factor;\n\t\tuniform vec2 u_scale;\n\t\tuniform vec2 u_offset;\n\t\t\n\t\tvoid main() {\n\t\t\tvec2 uv = v_coord;\n\t\t\tuv += ( texture2D(u_textureB, uv).rg - vec2(0.5)) * u_factor * u_scale + u_offset;\n\t\t\tgl_FragColor = texture2D(u_texture, uv);\n\t\t}\n\t\t", F.registerNodeType("texture/warp", B), y.title = "to Viewport", y.desc = 
  ...
  }, e.pixel_shader = "precision highp float;\n\t\tprecision highp float;\n\t\tuniform sampler2D u_texture;\n\t\tuniform sampler2D u_textureB;\n\t\tuniform float u_factor;\n\t\tvarying vec2 v_coord;\n\t\t\n\t\tvoid main() {\n\t\t\tgl_FragColor = mix( texture2D( u_texture, v_coord ), texture2D( u_textureB, v_coord ), u_factor );\n\t\t}\n\t\t", F.registerNodeType("texture/temporal_smooth", e), C.title = "Lineal Avg Smooth", C.desc = "Smooth texture linearly over time", C["@samples"] = {type:"number", 
  ...
  F.registerNodeType("texture/depth_range", d), f.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, f.title = "Linear Depth", f.desc = "Creates a color texture with linear depth", f.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
  ...
  F.registerNodeType("texture/linear_depth", f), g.title = "Blur", g.desc = "Blur a texture", g.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, g.max_iterations = 20, g.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a && this.isOutputConnected(0)) {
      ...
      d = Math.min(Math.floor(d), g.max_iterations);
      if (0 == d) {
        this.setOutputData(0, a);
      } else {
...
(function(v) {
  ...
  if ("undefined" != typeof GL) {
    ...
    r.prototype.onExecute = function() {
      ...
      if (this.properties.precision === LGraphTexture.PASS_THROUGH) {
        ...
        if (c) {
          ...
          this._tex.drawTo(function() {
            c.bind(0);
            z.uniforms({u_texture:0, u_aberration:h, u_distortion:m, u_blur:q}).draw(v);
          });
          this.setOutputData(0, this._tex);
        }
      }
    ...
    h.prototype.onExecute = function() {
      ...
      if (c && r && this.properties.shape) {
        ...
        if (q) {
          ...
          var e = h._first_shader;
          e || (e = h._first_shader = new GL.Shader(Shader.SCREEN_VERTEX_SHADER, h._first_pixel_shader));
          var C = h._second_shader;
          C || (C = h._second_shader = new GL.Shader(h._second_vertex_shader, h._second_pixel_shader));
          ...
          this._temp_texture.drawTo(function() {
            ...
            c.bind(0);
            q.bind(3);
            C.uniforms({u_texture:0, u_mask:2, u_shape:3, u_alpha:n, u_threshold:v, u_pointSize:H, u_itexsize:[1.0 / c.width, 1.0 / c.height]}).draw(D, gl.POINTS);
          });
          this.setOutputData(0, this._temp_texture);
        }
      } else {
    ...
    h.prototype.createPointsMesh = function(c, h, m) {
      for (var l = Math.round(c / m), r = Math.round(h / m), q = new Float32Array(l * r * 2), e = -1, v = 2 / c * m, y = 2 / h * m, u = 0; u < r; ++u) {
        ...
        if (this.properties.precision === LGraphTexture.PASS_THROUGH) {
          ...
          if (c) {
            ...
            this._tex.drawTo(function() {
              c.bind(0);
              "noise" == q && D.bind(1);
              E.uniforms({u_texture:0, u_noise:1, u_size:[c.width, c.height], u_rand:[Math.random(), Math.random()], u_value1:h, u_value2:r, u_camera_planes:C}).draw(e);
            });
            this.setOutputData(0, this._tex);
          }
        }
    ...
    q.prototype.onExecute = function() {
      ...
      if (this.properties.precision === LGraphTexture.PASS_THROUGH) {
        ...
        if (c) {
          ...
          this._tex.drawTo(function() {
            c.bind(0);
            r.uniforms({u_texture:0, u_intensity:h, u_isize:[1 / c.width, 1 / c.height], u_invert:v ? 1 : 0}).draw(m);
          });
          this.setOutputData(0, this._tex);
        }
      }
...
(function(v) {
  ...
  w.prototype.onExecute = function() {
    var c = p.getAudioContext().currentTime, a = this.audionode.gain, b = this.getInputData(1), d = this.getInputOrProperty("A"), e = this.getInputOrProperty("D"), g = this.getInputOrProperty("S"), h = this.getInputOrProperty("R");
