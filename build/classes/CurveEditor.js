...
var CurveEditor = exports.CurveEditor = function () {
    ...
    _createClass(CurveEditor, [{
        key: "draw",
        value: function draw(ctx, size, graphcanvas, background_color, line_color, inactive) {
        ...
        key: "onMouseUp",
        value: function onMouseUp(localpos, graphcanvas) {
            this.selected = -1;
            return false;
        }
    }, {
        key: "getCloserPoint",
        value: function getCloserPoint(pos, max_dist) {
            var points = this.points;
            if (!points) return -1;
